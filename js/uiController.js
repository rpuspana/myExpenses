    ...
    return {
        ...
        pblAddListItem: function(transcation, type) {
            ...
            if (type === "inc") {
                ...
                transactionListItem = '<div class="item clearfix" id="inc-%id%"><div class="item__description">%description%</div><div class="right clearfix"><div class="item__value" title="Value">%value%</div><div class="item__delete"><button class="item__delete__btn"><i class="ion-ios-close" title="Delete"></i></button></div></div></div>';
            ...
            // if the type of transaction is an expense
                ...
                transactionListItem = '<div class="item clearfix" id="exp-%id%"><div class="item__description">%description%</div><div class="right clearfix"><div class="item__value" title="Value">%value%</div><div class="item__percentage">-</div><div class="item__delete"><button class="item__delete__btn"><i class="ion-ios-close" title="Delete"></i></button></div></div></div>';
